## 01 - Application Design and Build - 20%
...
- [Use the Helm package manager to deploy existing packages](02-application-deployment/03-helm-package-manager-to-deploy-existing-packages.md)
...
- [Utilize container logs](./03-application-observability-and-maintenance/04-utilize-container-log.md)
